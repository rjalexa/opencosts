...
def _load_search_terms() -> List[str]:
    ...
    try:
        ...
        print("Warning: data/input/models_strings.txt not found, using default search terms")
        return [
            "Gemini 2.5",
            "Sonnet 4",
            "Opus 4",
...
if __name__ == "__main__":
    ...
    with open("data/output/openrouter_models_providers.csv", "w", newline="", encoding="utf-8") as f:
        w = csv.writer(f)
